    ...
    internal static class Program
    {
        ...
        private static int Main(string[] arguments)
        {
            using (Distro wslApi = new Distro(Configuration.DistroName))
            {
                ...
                {
                    Console.Out.WriteLine(Properties.Resources.MSG_MISSING_OPTIONAL_COMPONENT);
                ...
                if (!wslApi.IsDistributionRegistered)
                {
                    ...
                    if (NativeMethods.FAILED(hr))
                    {
                        ...
                        {
                            Console.Out.WriteLine(Properties.Resources.MSG_INSTALL_ALREADY_EXISTS);
                        }
                    }
                    else
                    {
                        Console.Out.WriteLine(Properties.Resources.MSG_INSTALL_SUCCESS);
                    }
                ...
                if (NativeMethods.SUCCEED(hr) && !installOnly)
                {
                    ...
                    {
                        Console.Out.WriteLine(Properties.Resources.MSG_USAGE);
                        return (int)exitCode;
                    }
                }
        ...
        {
            Console.Out.WriteLine(Properties.Resources.MSG_STATUS_INSTALLING);
            ...
            if (createUser)
            {
                Console.Out.WriteLine(Properties.Resources.MSG_CREATE_USER_PROMPT);
                string userName;

                do
                {
                    userName = Helpers.GetUserInput(Properties.Resources.MSG_ENTER_USERNAME);
                }
